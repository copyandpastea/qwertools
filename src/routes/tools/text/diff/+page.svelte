...
<div class="mx-auto px-4 py-6">
    ...
    <p class="text-sm text-zinc-600 mb-6">
        Compare two versions of text to see the differences. Paste the original
        text on the left and the modified text on the right, then click
        "Compare" to view the line-by-line differences. Added lines will be
        highlighted in green, while removed lines will be highlighted in red.
    </p>
                ...
                <tbody>
                    {#each lines as line}
                        ...
                        >
                            ...
                            <!-- 右内容 -->
                            <td class="px-2 py-1 whitespace-pre-wrap break-all align-top">
                                {line.rightContent}
                            </td>
                        </tr>
                    {/each}
